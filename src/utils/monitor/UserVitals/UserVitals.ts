...
import BehaviorStore, { behaviorStack, customAnalyticsData, metricsName, PageInformation } from './type'

import { proxyHash, proxyHistory } from "./history";
import { afterLoad } from "../WebVitals/WebVitals";
